    ...
    (sdl2:with-window (win :title "OGL" :w 800 :h 600 :flags '(:shown :opengl))
      ...
      (sdl2:with-gl-context (glc win)
        ...
        (let* ((vao (gl:gen-vertex-array))
          ...
          (gl:vertex-attrib-pointer pos-attr 3 :float :false
          ...
          (gl:vertex-attrib-pointer uv-attr 2 :float :false
                                    (* 5 (cffi:foreign-type-size :float))
                                    (* 3 (cffi:foreign-type-size :float)))

          ;; ;;;;;;;;;;;;;;;;;;;;;;;;;;;
          ;; bind seperate color attribute datastore into vao here
          ;; ;;;;;;;;;;;;;;;;;;;;;;;;;;;
          ...
          (gl:vertex-attrib-pointer color-attr 4 :float :false 0 0)
